...
namespace merge_B.Classes
{
    public class SecretaryClass:User
    {
        ...
        public Boolean addcourseStudent(string courseid,string id)
        {
            Boolean res = false;
            int numofStudents;
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO StudentCourses (StudID, CourseID) VALUES (@StudID, @CourseID)", Globals.conn);
        ...
        public void RequestTechnicalSupport(String Msg)
        {
