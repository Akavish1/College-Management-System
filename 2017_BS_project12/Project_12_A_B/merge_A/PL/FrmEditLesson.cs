...
namespace Project_Sce.PL
{
    public partial class FrmEditLesson : Form
    {
        ...
        {
          (new updateLesson(listView1.SelectedItems[0].SubItems[0].Text.ToString(), listView1.SelectedItems[0].SubItems[4].Text.ToString(),listView1.SelectedItems[0].SubItems[5].Text.ToString(),listView1.SelectedItems[0].SubItems[6].Text.ToString())).Show();
        }
