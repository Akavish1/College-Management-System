...
namespace Project_Sce.CodeLayer
{
    ...
    //    public void Update_availability(string name,Boolean availability, string d, int strt, int end)
    //    {
    //        Project_Sce.DAL.DataBase DAl = new Project_Sce.DAL.DataBase();
    //        try
    //        {
    //            DAl.open();
    //            SqlCommand cmd = new SqlCommand("UPDATE Class SET availability=@availability, day=@day, strtTime=@strtTime, endTime=@endTime WHERE name = @name", DAl.Return_Connection());
    //            cmd.Parameters.AddWithValue("@name", name);
    //            cmd.Parameters.AddWithValue("@availability", availability);
    //            cmd.Parameters.AddWithValue("@day", d);
    //            cmd.Parameters.AddWithValue("@strtTime", strt);
