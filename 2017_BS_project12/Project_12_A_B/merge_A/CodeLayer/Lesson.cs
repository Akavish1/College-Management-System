...
namespace Project_Sce.CodeLayer
{
    public class Lesson
    {
        ...
        public DataTable get_lecID()
        {
            Project_Sce.DAL.DataBase DAl = new Project_Sce.DAL.DataBase();
            DAl.open();
            DataTable dt = new DataTable();
            dt = DAl.SelectData("get_lecID", null);
            DAl.close();
            return dt;
        }

        public void Add_Lesson(string category_cat, string class_cat, string course_cat, string lecturer_cat, string day_cat, int strt_cat, int end_cat, int numOfStud)
        {
            Project_Sce.DAL.DataBase DAl = new Project_Sce.DAL.DataBase();
            DAl.open();
        ...
        public void Update_Lesson(string category_cat, string class_cat, string lecturer_cat, string day_cat, int strt_cat, int end_cat)
        {
            Project_Sce.DAL.DataBase DAl = new Project_Sce.DAL.DataBase();
            DAl.open();
            ...
            p[2] = new SqlParameter("@LecturerID", SqlDbType.NVarChar, 20);
            p[2].Value = lecturer_cat;

            p[3] = new SqlParameter("@Day", SqlDbType.NVarChar, 10);
            p[3].Value = day_cat;

            p[4] = new SqlParameter("@StrtTime", SqlDbType.Int);
            p[4].Value = strt_cat;

            p[5] = new SqlParameter("@EndTime", SqlDbType.Int);
            p[5].Value = end_cat;
