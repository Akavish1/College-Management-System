    ...
    public partial class Schedule : MetroForm
    {
        ...
        private void compCoursesText_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //Do registering.. and save to DB. ==> #3
                Project_12_A_B.Forms.Student.RegisterToCourse a = new Project_12_A_B.Forms.Student.RegisterToCourse(compCoursesText.GetItemText(compCoursesText.SelectedItem));
                a.ShowDialog();
